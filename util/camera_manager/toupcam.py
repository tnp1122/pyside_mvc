...
TOUPCAM_OPTION_AUTOEXP_EXPOTIME_DAMP  = 0x60       # Auto exposure damp: time (thousandths)
TOUPCAM_OPTION_AUTOEXP_GAIN_DAMP      = 0x61       # Auto exposure damp: gain (thousandths)
...
TOUPCAM_IOCONTROLTYPE_GET_INPUT_STATE           = 0x3c  # Input state: 0 (low level) or 1 (high level)
...
TOUPCAM_TEMP_MIN                 = 1000     # color temperature, minimum value
TOUPCAM_TEMP_MAX                 = 25000    # color temperature, maximum value
TOUPCAM_TINT_DEF                 = 1000     # tint
TOUPCAM_TINT_MIN                 = 100      # tint
...
TOUPCAM_BRIGHTNESS_MIN           = -128     # brightness
TOUPCAM_BRIGHTNESS_MAX           = 128      # brightness
TOUPCAM_CONTRAST_DEF             = 0        # contrast
TOUPCAM_CONTRAST_MIN             = -150     # contrast
TOUPCAM_CONTRAST_MAX             = 150      # contrast
...
TOUPCAM_AUTOEXPO_DAMP_DEF        = 0        # auto exposure damp: thousandths
TOUPCAM_AUTOEXPO_DAMP_MIN        = 0        # auto exposure damp: thousandths
TOUPCAM_AUTOEXPO_DAMP_MAX        = 1000     # auto exposure damp: thousandths
...
TOUPCAM_TEC_TARGET_DEF           = 100      # TEC target: 10.0 degrees Celsius
...
class Toupcam:
    ...
    @classmethod
    def Version(cls):
        """get the version of this dll, which is: 55.25120.20240331"""
        cls.__initlib()
    ...
    def PixelFormatName(cls, val):
        cls.__initlib()
        return cls.__lib.Toupcam_get_PixelFormatName(val)
