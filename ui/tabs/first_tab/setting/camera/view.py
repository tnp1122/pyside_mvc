...
class SettingCameraView(BaseWidgetView):
    ...
    def __init__(self, parent=None):
        ...
        lyt_expo.addLayout(self.get_slider_layout(QLabel("타겟: "), self.lb_expo_target, self.slider_expo_target))
        lyt_expo.addLayout(self.get_slider_layout(QLabel("노출 시간:"), self.lb_expo_time, self.slider_expo_time))
        ...
        lyt_WB = QVBoxLayout()
        lyt_WB.addLayout(self.get_slider_layout(QLabel("색 온도:"), self.lb_temp, self.slider_temp))
        lyt_WB.addLayout(self.get_slider_layout(QLabel("색조:"), self.lb_tint, self.slider_tint))
        # lyt_WB.addWidget(self.btn_auto_WB)
        lyt_WB.addLayout(self.get_twin_button_layout(self.btn_auto_WB, self.btn_init_WB))
        ...
        lyt_BB = QVBoxLayout()
        lyt_BB.addLayout(self.get_slider_layout(QLabel("빨강:"), self.lb_r, self.slider_r))
        lyt_BB.addLayout(self.get_slider_layout(QLabel("녹색:"), self.lb_g, self.slider_g))
        lyt_BB.addLayout(self.get_slider_layout(QLabel("파랑:"), self.lb_b, self.slider_b))
        lyt_BB.addLayout(self.get_twin_button_layout(self.btn_auto_BB, self.btn_init_BB))
        ...
        lyt_color.addLayout(self.get_slider_layout(QLabel("색상:"), self.lb_hue, self.slider_hue))
        lyt_color.addLayout(self.get_slider_layout(QLabel("채도:"), self.lb_saturation, self.slider_saturation))
        lyt_color.addLayout(self.get_slider_layout(QLabel("밝기:"), self.lb_brightness, self.slider_brightness))
        lyt_color.addLayout(self.get_slider_layout(QLabel("명암:"), self.lb_contrast, self.slider_contrast))
        lyt_color.addLayout(self.get_slider_layout(QLabel("감마:"), self.lb_gamma, self.slider_gamma))
        ...
        wig_setting = QWidget()
        lyt_setting = QVBoxLayout(wig_setting)
        lyt_setting.addWidget(gbox_res)
        lyt_setting.addWidget(gbox_expo)
        lyt_setting.addWidget(gbox_WB)
        lyt_setting.addWidget(gbox_BB)
        lyt_setting.addWidget(gbox_color)

        scl_setting = QScrollArea()
        scl_setting.setWidgetResizable(True)
        scl_setting.setHorizontalScrollBarPolicy(Qt.ScrollBarAlwaysOff)
        scl_setting.setVerticalScrollBarPolicy(Qt.ScrollBarAsNeeded)
        scl_setting.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
        scl_setting.setWidget(wig_setting)
